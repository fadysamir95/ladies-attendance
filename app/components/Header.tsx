...
const links = [
  { href: "/", label: "الصفحة الرئيسية", adminOnly: false },
  { href: "/women", label: "إدارة السيدات", adminOnly: false },
  { href: "/session", label: "تسجيل الحضور", adminOnly: true },
  { href: "/reports", label: "تقارير المواظبة", adminOnly: false },
];
...
function getUserLabel(u: User) {
  ...
  const map: Record<string, string> = {
    ...
    "viewer@viewer.com": "خادمة باجتماع السيدات",
  };
    ...
    <header style={s.header} dir="rtl">
      <div className="hdrWrap" style={s.wrap}>
        <div className="hdrTop" style={s.topRow}>
          <Link href="/">
            <img src="/logo.png" alt="اجتماع السيدات" height={60} style={s.logo} />
          </Link>
          ...
          <button onClick={logout} style={s.logout} className="logout" type="button">
            تسجيل الخروج
          </button>
        </div>
